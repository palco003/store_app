...
import cen4270.exceptions.CannotChargeCreditCard;
...
public class BankService {
     ...
     * @throws CannotChargeCreditCard Exception thrown if the credit cannot be charged for any reason
     */
    public void chargeCreditCard(CreditCard creditCard, int amount) throws CannotChargeCreditCard {
